...
import com.cybermax.digitaloutpatient.fragment.desk.ChargeDeskFragment;
 ...
 * 收费台
 */
public class ChargeDeskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (String title : mTitles) {
            if(TextUtils.equals("首页", title)){
                mFragments.add(new ChargeDeskFragment());
