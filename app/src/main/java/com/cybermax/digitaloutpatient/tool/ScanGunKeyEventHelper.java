...
public class ScanGunKeyEventHelper {
    ...
    private final Runnable mScanningFishedRunnable = new Runnable() {
        @Override
        public void run() {
//            Toast.makeText(mContext, "sao ma cheng gong ", Toast.LENGTH_SHORT).show();
            performScanSuccess();
        }
    };
    private Context mContext;

    public ScanGunKeyEventHelper(Context mContext, OnScanSuccessListener onScanSuccessListener) {
...
//        mDeviceName = new UsbDeviceNameUtil(mContext).getUSBName();
