...
public class BorderEffect implements Effect {
    ...
    List<FocusListener> mFocusListener = new ArrayList<FocusListener>(1);
    List<Animator.AnimatorListener> mAnimatorListener = new ArrayList<Animator.AnimatorListener>(1);
