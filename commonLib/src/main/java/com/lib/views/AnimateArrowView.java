...
public class AnimateArrowView extends View {
     ...
     */
    private float mArrowHeightRatio = 3.0f;
    /**
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY && heightMode == MeasureSpec.EXACTLY) {
            ...
            measuredWidth = (mViewWidth + getPaddingLeft() + getPaddingRight()) + 100;
            measureHeight = heightSize;
        } else {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        int left = (int) (mViewScale * mArrowTopMargin);
        int top = 0;
    ...
    private void initAnimator() {
        ...
        ValueAnimator animatorY = ValueAnimator.ofInt(100, 0);//mTranslateRange
