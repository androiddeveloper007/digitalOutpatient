...
public class CircularProgressView extends View {
    ...
    private void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        color = a.getColor(R.styleable.CircularProgressView_cpv_color, resources.getColor(R.color.blue_light));
...
//            color = t.getColor(0, resources.getColor(R.color.blue_light));
//        } else {
//            //Use default color
